    ...
    return (
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {Array.from({ length: count }).map((_, i) => (
          <div key={i} className="bg-white dark:bg-jet-elevated rounded-2xl p-6 animate-pulse">
  ...
  if (type === 'table') {
    return (
      <div className="animate-pulse space-y-3">
        {Array.from({ length: count }).map((_, i) => (
          <div key={i} className="bg-white dark:bg-jet-elevated rounded-xl p-4 flex items-center gap-4">
