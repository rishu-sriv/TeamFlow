export default function RoleBadge({ role }) {
  ...
  return (
    <span className="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-semibold bg-slate-100 text-slate-600 dark:bg-jet-elevated dark:text-slate-300">
      Member
    </span>
  )
}
